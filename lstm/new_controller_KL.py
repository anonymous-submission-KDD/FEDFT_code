#new_controller_KL.py

import torch
import torch.nn as nn
from transformers import BartTokenizer

from new_feature_env_KL import FeatureEvaluator
from lstm.new_decoder_KL import construct_decoder
from lstm.new_encoder_KL import construct_encoder
...
class GAFS(nn.Module):
    ...
    #optimize RNN memory efficiency（Valid for RNN,LSTM,GRU）
    ...
    def embed(self, input_ids: torch.LongTensor) -> torch.Tensor:
        ...
        _, _, feat_emb, _, _,_ = self.encoder.forward(input_ids)
        return feat_emb.squeeze(0)
